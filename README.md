...
├── code/                         --
├── corpus/                       --
│   ├── es_zone_annotations.txt   -- 
│   ├── fr_zone_annotations.txt   -- 
...
# Retrieve the email textual content
...
# Open Cleverly Corpus and match Ids (Python)
...
import io
import json
with io.open('fr_zone_annotations.txt', encoding="utf-8") as json_file:
